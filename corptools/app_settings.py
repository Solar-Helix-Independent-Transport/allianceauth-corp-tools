...
CT_CHAR_OPPORTUNITIES = getattr(settings, 'CT_CHAR_OPPORTUNITIES', False)
...
CT_COMPAT_DATE_OVERRIDE = getattr(settings, 'CT_COMPAT_DATE_OVERRIDE', False)

CT_DB_BULK_CREATE_BATCH_SIZE = getattr(
    settings, 'CT_DB_BULK_CREATE_BATCH_SIZE', 1000)
