...
class TestCorptoolsAccessPerms(TestCase): 
    def setUp(cls):
        ...
        cls.view_corp_permission = Permission.objects.get_by_natural_key('corp_hr', 'corptools', 'characteraudit')
        cls.view_alliance_permission = Permission.objects.get_by_natural_key('alliance_hr', 'corptools', 'characteraudit')
        cls.view_all_permission = Permission.objects.get_by_natural_key('global_hr', 'corptools', 'characteraudit')
