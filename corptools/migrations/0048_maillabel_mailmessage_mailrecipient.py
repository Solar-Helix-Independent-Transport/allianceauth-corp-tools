    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label_name', models.CharField(default=None, max_length=255, null=True)),
                ('label_color', models.CharField(default=None, max_length=7, null=True)),
        ...
        migrations.CreateModel(
            name='MailRecipient',
            fields=[
                ('recipient_id', models.BigIntegerField(primary_key=True, serialize=False, unique=True)),
                ('recipient_type', models.CharField(choices=[('alliance', 'alliance'), ('character', 'character'), ('corporation', 'corporation'), ('mailing_list', 'mailing_list')], max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='MailMessage',
            fields=[
                ('id_key', models.BigIntegerField(primary_key=True, serialize=False, unique=True)),
                ...
                ('recipients', models.ManyToManyField(to='corptools.MailRecipient')),
            ],
        ),
    ]
