    ...
    <div className="d-flex flex-wrap justify-content-center">
      ...
      <Card className="m-2">
        ...
        <div className="d-flex align-items-center flex-wrap justify-content-center">
          <IconStatusDiv
            iconSrc={Battleship}
            {...statusProps(data?.officer, isLoading)}
            toolTipText={t("Count of Officer bounties earnt")}
          />
          <IconStatusDiv
            iconSrc={Cruiser}
            {...statusProps(data?.officer_cruiser, isLoading)}
            toolTipText={t("Count of Officer Cruiser bounties earnt")}
          />
          <IconStatusDiv
            iconSrc={Frigate}
            {...statusProps(data?.officer_frigate, isLoading)}
